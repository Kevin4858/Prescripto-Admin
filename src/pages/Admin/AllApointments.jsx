    ...
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border border-zinc-300 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        {appointments.map((item, idx) => (
          <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] text-gray-500 py-3 px-6 border-b border-zinc-300 hover:bg-gray-50' key={idx}>
            ...
            <p>{currency}{item.amount}</p>
            {
              item.cancelled
                ...
                : item.isCompleted
                  ...
                  : <img onClick={() => cancelAppointment(item._id)} className='w-10 ml-4 cursor-pointer' src={assets.cancel_icon} alt="" />
            }
          </div>
        ))}
      </div>
